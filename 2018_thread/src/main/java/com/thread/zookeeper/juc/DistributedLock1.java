...
public class DistributedLock1 {  
    ...
    public DistributedLock1(ZooKeeper zk,int sessionTimeout) {  
        this.zk = zk;  
        this.sessionTimeout = sessionTimeout;  
    }  
  
    public DistributedLock1() throws IOException, KeeperException, InterruptedException {  
